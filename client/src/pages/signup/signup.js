  ...
  function LoginWithEmail(){
    ...
    return (
        <MDBContainer fluid>
          ...
          <div className="p-5 bg-image" style={{backgroundImage: 'url(https://th.bing.com/th/id/OIP.vvO0qwaFl_P7bAPM1ArrRgHaE8?pid=ImgDet&w=184&h=122&c=7&dpr=1.3)', height: '300px'}}></div>
